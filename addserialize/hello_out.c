...
{ 
  ...
  {
  __serialize_scalar32(& ptr->head, fd);
  __serialize_ptr_list_node(& ptr->tail, fd);
  __serialize_ptr_list_node(& ptr->self1, fd);
  __serialize_ptr_list_node(& ptr->self2, fd);
  __serialize_yu(& ptr->y, fd);
}
}
void __deserialize_yu(struct yu *ptr , int fd ) 
{ 
...
{ 
  ...
  {
  __deserialize_scalar32(& ptr->head, fd);
  __deserialize_ptr_list_node(& ptr->tail, fd);
  __deserialize_ptr_list_node(& ptr->self1, fd);
  __deserialize_ptr_list_node(& ptr->self2, fd);
  __deserialize_yu(& ptr->y, fd);
}
}
void __deserialize_scalar32(int *ptr , int fd ) 
{ 
